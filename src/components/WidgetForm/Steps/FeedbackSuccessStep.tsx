...
export function FeedbackSuccesStep ({onFeedbackRestartRequested}:FeedbackSuccesStepProps){
    return (
        ...
        <button
            ...
            className="py-2 px-6 mt-2 bg-zinc-800 rounded-md border-transparent text-sm leading-6 hover:bg-zinc-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-red-400 disabled:opacity-50 disabled:hover:bg-red-500"
        >
            Quero enviar outro
        </button>
        </div>
